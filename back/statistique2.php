...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [  <?php 
                        ...
                        $sql = "SELECT COUNT(month(date_actuelle)) from reclamation where  month(date_actuelle)=4";
    ...
    , <?php 
        ...
        $connection = mysqli_connect("localhost", "root", "", "projet");
        $sql = "SELECT COUNT(month(date_actuelle)) from reclamation where  month(date_actuelle)=5";
        $query = mysqli_query($connection, $sql);
        $table = null;
        while ($row = mysqli_fetch_array($query)) {
            $table = $row[0];
